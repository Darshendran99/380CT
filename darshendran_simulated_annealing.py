...
# [In Step 1 ] 1. Generate a random solution for the problem and call it S
def generate_random_solution(array, length):
    indices = sorted(random.sample(list(range(len(array))), length))
    return [array[i] for i in indices]


# [In Step 4 ]4. ~~~Compute the neighborhood of S~~~ and choose S' as the best solution in the neighborhood
